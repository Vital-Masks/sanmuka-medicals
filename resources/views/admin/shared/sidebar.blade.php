 ...
 <aside class="main-sidebar elevation-4 sidebar-dark-warning">
   ...
   <a href="{{route('dashboard')}}" class="brand-link">
     <img src="{{ asset('img/logo.jpg') }}" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
         ...
         <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
           ...
           <nav class="mt-2">
             <ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
               ...
               <li class="nav-item menu-is-opening ">
                 <a href="{{route('PrescriptionOrders')}}" class="nav-link">
                   <i class="nav-icon fas fa-tachometer-alt"></i>
               ...
               <li class="nav-item">
                 <a href="{{ route('ManageMedicines') }}" class="nav-link">
